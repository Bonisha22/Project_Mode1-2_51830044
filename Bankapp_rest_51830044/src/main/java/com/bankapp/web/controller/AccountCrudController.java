...
public class AccountCrudController {
	...
	public Account createAccount(@RequestBody AccountReq req){
		...
		Account account=new Account(req.getName(), req.getAccountBalance(), req.getBlocked());
		Customer customer=new Customer(req.getName(), req.getEmail(), req.getAddress(),
				req.getPhone(), req.getCity(),req.getCountry());
