...
import com.bankapp.web.controller.beans.DepositAndWithdrawRequest;
...
public class AccountTransactionController {
	...
	public String deposit(@RequestBody DepositAndWithdrawRequest req, @AuthenticationPrincipal SecUser user) {
	...
	public String withdraw(@RequestBody DepositAndWithdrawRequest req, @AuthenticationPrincipal SecUser user) {
