...
public class UserMgntController {
	...
	// @PostConstruct
	public void init() {
		userService.addUser(new User("boni", "b@gmail.com", "boni23", "admin", true));
		userService.addUser(new User("aswini", "a@gmail.com", "ash14", "mgr", true));
		userService.addUser(new User("maha", "m@gmail.com", "maha11", "emp", true));
	}
